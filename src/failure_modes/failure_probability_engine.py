...
from src.failure_modes.confidence_scoring import (
    calculate_signature_strength
)
...
class FailureProbabilityEngine:
    ...
    def calculate(self, machine_profile, failure_profiles, top_driver_df):
        ...
        shap_weights = dict(
            zip(
                top_driver_df["Feature"],
                top_driver_df["Influence_Strength"]
            )
        )
        ...
        for mode, profile_data in failure_profiles.items():
            ...
            for feature in shap_weights:
                if (
                    feature not in machine_profile.index or
                    feature not in profile_median
                ):
                    continue
        ...
        probabilities = {
            mode: round(score / total_score * 100, 2)
            for mode, score in inverse_scores.items()
        }
        ...
        failure_probability_table = (
            ...
            .rename(columns={
                ...
                "Probability_%": "probability_percent"
            })
        ...
        # SIGNATURE STRENGTH
        # ==================================================
        signature_strength, pattern_strength, separation = (
            calculate_signature_strength(probability_df)
        )
